            ...
            <div class="flex items-center justify-between gap-6 px-6 py-4 lg:px-10">
                ...
                <nav aria-label="Main navigation" class="hidden items-center gap-2 text-sm font-medium lg:flex">
                    <RouterLink
                        ...
                        class="rounded-xl px-4 py-2 text-stone-600 transition hover:bg-stone-100 hover:text-stone-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                    >
                        {{ link.label }}
                    </RouterLink>
                </nav>
                <div class="flex items-center gap-3 text-sm">
                    ...
                    <button
                        class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-stone-300 bg-white text-stone-700 shadow-sm transition hover:border-stone-400 hover:text-stone-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                        type="button"
                        @click="logout"
                    >
            ...
            <aside class="hidden w-full border-b border-stone-200/80 bg-white/70 p-6 backdrop-blur lg:flex lg:w-72 lg:flex-col lg:gap-8 lg:border-b-0 lg:border-r">
                <nav aria-label="Workspace navigation" class="space-y-2 text-sm font-medium text-stone-600">
                    ...
                    <RouterLink
                        ...
                        :to="link.to"
                        active-class="bg-blue-50/90 text-blue-700 ring-1 ring-inset ring-blue-200"
                        class="flex items-center justify-between gap-2 rounded-xl px-4 py-2 transition hover:bg-stone-100 hover:text-stone-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                    >
